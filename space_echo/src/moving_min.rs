...
mod tests {
  ...
  fn should_hold_minimum_for_attack_time_in_ms() {
    ...
    assert_eq!(moving_min.run(10.0), 1.); 

    assert_eq!(moving_min.run(0.7), 0.7); 
    assert_eq!(moving_min.run(1.2), 0.7); 
    assert_eq!(moving_min.run(1.2), 0.7); 
    assert_eq!(moving_min.run(1.2), 0.7); 

    assert_eq!(moving_min.run(1.2), 1.0); 
  }
  ...
  fn should_hold_new_minimums_that_occur_in_the_hold_window() {
    ...
    // test 1
    assert_eq!(moving_min.run(0.3), 0.3);
    assert_eq!(moving_min.run(0.8), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
    
    assert_eq!(moving_min.next_hold_length, 0);
    assert_eq!(moving_min.run(1.6), 0.8);
    assert_eq!(moving_min.run(1.5), 1.0);

    // test 2
    assert_eq!(moving_min.run(0.3), 0.3);
    assert_eq!(moving_min.run(0.8), 0.3);
    assert_eq!(moving_min.run(0.5), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
    
    assert_eq!(moving_min.next_hold_length, 1);
    assert_eq!(moving_min.run(1.6), 0.5);
    assert_eq!(moving_min.run(1.6), 0.5);
    assert_eq!(moving_min.run(1.5), 1.0);
    ...
    assert_eq!(moving_min.run(0.8), 0.3);
    assert_eq!(moving_min.run(0.5), 0.3);
    assert_eq!(moving_min.run(0.6), 0.3);
    
    assert_eq!(moving_min.next_hold_length, 2);
    assert_eq!(moving_min.run(1.6), 0.5);
    assert_eq!(moving_min.run(1.5), 0.5);
    assert_eq!(moving_min.run(1.5), 0.5);
    assert_eq!(moving_min.run(1.5), 1.0);

    // test 4
    assert_eq!(moving_min.run(0.3), 0.3);
    assert_eq!(moving_min.run(1.8), 0.3);
    assert_eq!(moving_min.run(1.5), 0.3);
    assert_eq!(moving_min.run(0.5), 0.3);
    
    assert_eq!(moving_min.next_hold_length, 2);
    assert_eq!(moving_min.run(1.6), 0.5);
    assert_eq!(moving_min.run(0.8), 0.5);
    assert_eq!(moving_min.run(0.6), 0.5);

    assert_eq!(moving_min.next_hold_length, 2);
    assert_eq!(moving_min.run(1.6), 0.6);
    assert_eq!(moving_min.run(1.6), 0.6);
    assert_eq!(moving_min.run(1.6), 0.6);
    assert_eq!(moving_min.run(1.6), 1.0);
  }
  ...
  fn should_hold_minimum_for_attack_plus_hold_time_in_ms() {
    ...
    assert_eq!(moving_min.run(0.3), 0.3);
    assert_eq!(moving_min.run(0.8), 0.3);
    assert_eq!(moving_min.run(1.2), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
    assert_eq!(moving_min.run(1.3), 0.3);
  ...
  fn should_not_exceed_limit() {
    ...
    assert_eq!(moving_min.run(10.0), 0.5); 
    ...
    assert_eq!(moving_min.run(1.2), 0.5); 
  }
}